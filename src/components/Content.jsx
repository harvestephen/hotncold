  ...
  return (
    <>
      <div className="max-w-full flex items-center flex-col mx-8">
        {/**Button */}
        <div className="flex gap-3 max-w-7xl w-full mx-8 my-8">
        ...
        <div className="flex flex-row justify-between max-w-7xl w-full">
          <div className="flex-1">
            ...
            <hr className="max-w-7xl w-full my-2" />

            {/**Tasks */}
            <div className="flex flex-row justify-between max-w-7xl w-full bg-[#D9D9D9] rounded-sm px-2 py-2 mb-1">
              <div>
                <input type="checkbox" />
          ...
          <div className="w-1/4 bg-[#D9D9D9] rounded-lg ml-8 h-96 text-center align-middle">
            Calendar
          </div>
        </div>
      </div>
