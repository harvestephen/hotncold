...
export default function Content() {
  ...
  function mapTasks(array) {
    ...
    let htmlTask = tasks.map((item) => <div className="flex flex-row justify-between max-w-[100rem] w-full bg-[#D9D9D9] rounded-sm px-2 py-2 mb-1">
    <div>
      <input type="checkbox" />
      <span className="text-sm pl-4">{item}</span>
    </div>
